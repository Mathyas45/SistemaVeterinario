                            ...
                            <div class="row bg-white">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" style="resize: none;" readonly><?= $notas_padecimiento ?> </textarea>
                                    </div>
                                        ...
                                        <div class="form-group" id="contenedor-archivos">
                                            ...
                                            <ul>
                                                <?php foreach ($historias as $historia) : ?>
                                                    <li><a href="<?= $historia['url_prueba'] ?>" target="_blank"><?= $historia['nombre_prueba'] ?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                    ...
                                    <div class="col-md-6">
                                        <div id="formulario">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" style="resize: none;" readonly><?= $notas_tratamiento ?></textarea>
                                            </div>
                                            <br>
                                            <div class="card">
